...
export function TranslatedForm2({ fields, languages, onSubmit, initialData, isLoading, sharedFields = [] }: TranslatedFormProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // Create the submission data without filtering empty translations
    ...
    try {
      // Pass all form data to onSubmit, including empty translations
